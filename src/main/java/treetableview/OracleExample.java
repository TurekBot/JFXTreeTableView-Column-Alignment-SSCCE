...
public class OracleExample extends Application {
    ...
    public static void main(String[] args) {
        Application.launch(OracleExample.class, args);
    }
    ...
    public void start(Stage stage) {
        ...
        treeTableView.getStylesheets().add(getClass().getResource("/css/styles.css").toExternalForm());
